...
public class Minim
{
  ...
  /**
  * Added methods for VirtualActor project (04.06.2013)
  */
  public AudioSample loadSample(AudioInputStream ais)
  {
    return loadSample(ais, 1024);
  }
  public AudioSample loadSample(AudioInputStream ais, int bufferSize)
  {
	    return mimp.getAudioSample(ais, bufferSize);
  }
